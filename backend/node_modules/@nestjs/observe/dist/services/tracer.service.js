...
import { CALLER_METADATA_KEY, OBSERVE_OPTIONS, TRACE_REGISTRY_KEY, } from "../observe.constants.js";
...
let TracerService = class TracerService {
    ...
    async captureError(error, tags) {
        ...
        const traceId = store.get(TRACE_REGISTRY_KEY) ??
